...
const aprender = listado.map(el => el.textContent); 
...
const aprenderOne = Array.from(
    document.querySelectorAll("li"),
    elemento => elemento.textContent
);
//console.log(aprenderOne);
...
console.log(users.splice(indiceSeleccionado,1));//Eliminar indice 9
...
// Array includes
console.log(Array.of(1, 2, 3, 4, 5, 6).includes(3));
